...
namespace mylib
{
    ...
    namespace audio
    {
        ...
        private:
            ...
            std::unique_ptr<DirectX::SoundEffect>			music[mylib::MUSIC_FILE_MAX];
            std::unique_ptr<DirectX::SoundEffectInstance>	musicInst[mylib::MUSIC_FILE_MAX];
            float											musicVolume[mylib::MUSIC_FILE_MAX];

            //サウンド用
            std::unique_ptr<DirectX::WaveBank>				waveBank;
            std::unique_ptr<DirectX::SoundEffectInstance>	soundInst[mylib::WAVE_FILE_MAX][mylib::WAVE_SOUND_MAX];//最大8音を同時再生可能
            float											soundVolume[mylib::WAVE_FILE_MAX];
        };
    }
